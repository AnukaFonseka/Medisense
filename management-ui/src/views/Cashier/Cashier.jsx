                        ...
                        <div className="common__info__details">
                            ...
                            <div className="row">
                                <div className="col">
                                    ...
                                    <input className="form-control" type="text" id="cheque" name="cheque"/>
                                </div>
                                <div className="col">
                                    <label htmlFor="country">Credit Approved By</label>
                            ...
                            <div className="row">
                                <div className="col_box">
                                    ...
                                    <input className="form-control" type="text" id="chequeDate" name="chequeDate"/>
                                </div>
                            </div>
